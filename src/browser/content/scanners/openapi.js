...
export default class OpenApiScanner {
  ...
  async scan(document) {
    ...
    if (res.indexOf(true) === -1) {
      throw new Error('Not a valid Open API resource');
    }
    ...
    // check for the 'openapi' attribute
    if (typeof content.openapi === 'undefined') {
