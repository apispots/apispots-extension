	...
	var _private = {
		...
		'draw' : function draw(catalog, opts) {
			...
			try {
				...
				$('body').append(
						"<div id='container-graph' class='swagger-graph'></div>");
		...
		'onCatalogDetails' : function(node) {
			...
			try {
				...
				// image
				if (typeof catalog.image != 'undefined') {
					html += "<div class='row'>"
							+ "<div class='col-md-6'><img class='img-responsive' src='"
							+ catalog.image + "'></div>" + "<div class='col-md-6'>"
							+ catalog.description + "</div>" + "</div><hr>";
				}
				...
				if (typeof catalog.url != 'undefined') {
					...
					html += "<dl class='dl-horizontal'><dt>URL</dt><dd><a target='_blank' href='" + catalog.url + "'>"
							+ catalog.url + "</a></dd></dl>";
				}
			  ...
			  // updated
				if (typeof catalog.updated != 'undefined') {
					
					html += "<dl class='dl-horizontal'><dt>Updated at</dt><dd>"
							+ catalog.updated + "</dd></dl>";
				}
				 ...
				 * Properties
				 */
				// if (typeof catalog.properties != 'undefined') {
				//					
				// html += "<div class='section-properties'>";
				// html += "<h4>Properties <small>List of catalog
				// properties</small></h4>";
				// html += "<table class='table table-condensed'>";
				// html += "<thead><tr><th>Type</th><th>URL</th></tr></thead><tbody>";
				//					
				// for ( var idx in catalog.properties) {
				//						
				// // get the property
				// var property = catalog.properties[idx];
				//						
				// /*
				...
				// html += "<h4>Contact <small>Get in touch with the
				// providers</small></h4>";
				...
				// html += "<dl class='dl-horizontal'><dt>Terms of service</dt><dd><a
				// href='"
				// + info.termsOfService
				// + "' target='_blank'>"
